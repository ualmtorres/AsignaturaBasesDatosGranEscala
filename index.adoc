...
Máster en Ingeniería Informática. Manuel Torres <mtorres@ual.es>
...
////
La asignatura Bases de datos a gran escala es una asignatura optativa del módulo de Especialidad en Big Data del https://www.ual.es/estudios/masteres/presentacion/7114[Máster oficial en Ingeniería Informática] de la UAL. En la asignatura se hace una introducción a las bases de datos no relacionales (NoSQL) y a su uso en aplicaciones escalables.
...
* https://ualmtorres.github.io/posts/bases-de-datos-clave-valor[Bases de datos clave-valor]
...
* https://ualmtorres.github.io/posts/tutorial-api-rest-slim-mongodb-productos-valoraciones[Desarrollo de una API REST para gestión de productos y valoraciones con Slim Framework y MongoDB]
...
* link:Labs/Lab03/index-slim.html[Lab 03. Desarrollo de un Blog con PHP y MongoDB (Versión Slim)]
...
* link:Labs/Lab06/index-slim.html[Lab 06. Desarrollo de un aplicación PHP para la consulta de información cinematográfica almacenada en Neo4j (Versión Slim)]
...
* link:CasosDeUso/index.html[Casos de uso]
****
