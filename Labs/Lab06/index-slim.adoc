...
* Hacer fork del https://github.com/ualmtorres/Neo4jMoviesSlimIncompleto[[repositorio de base] y completar los scripts PHP para que la aplicación funcione correctamente. Los scripts PHP son los siguientes, modificando los lugares en los que aparece `YOUR CODE HERE`:
...
image::../../images/lab06-movies-home.png[Home]
...
image::../../images/lab06-movies-movie.png[Movie]
...
image::../../images/lab06-movies-search-movie.png[Search]
...
image::../../images/lab06-movies-actor.png[Actor]
