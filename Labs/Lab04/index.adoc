...
////
# Lab 04 Bases de datos a gran escala. Framework de Agregación de MongoDB. Máster en Ingeniería Informática
...
* Importar el archivo JSON `zips.json` disponible en link:https://github.com/ualmtorres/SampleDatabases[SampleDatabases] en una colección `zips` dentro de una base de datos denominada `zips`.
****
...
[NOTE]
====
Puedes importar el archivo JSON `bios.json` disponible en link:https://github.com/ualmtorres/SampleDatabases[SampleDatabases] en una colección `bios`.
====
+
Resultado:
+
