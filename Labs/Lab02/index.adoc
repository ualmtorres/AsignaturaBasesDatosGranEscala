...
. Importar el archivo JSON `zips.json` disponible en la carpeta link:https://github.com/ualmtorres/SampleDatabases[SampleDatabases] en una colección `zips` dentro de una base de datos denominada `zips`.
