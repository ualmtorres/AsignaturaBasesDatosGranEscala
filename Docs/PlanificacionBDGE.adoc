...
*** Estudio de casos prácticos de aplicación de bases de datos NoSQL en entornos reales o ficticios para fomentar la toma de decisiones, el debate y la argumentación.
...
*** Aprendizaje autónomo o autodirigido donde los estudiantes asumen el control de su proceso de aprendizaje y trabajan de forma independiente para adquirir conocimientos y habilidades.
*** Tutoriales en modalidad de _flipped classroom_, donde los alumnos realizan la actividad de forma autónoma y se resuelven dudas en la clase presencial.
*** Estudio de casos prácticos de bases de datos clave-valor en entornos reales o ficticios para fomentar la toma de decisiones, el debate y la argumentación.
*** Aprendizaje Basado en Competencias enfocado en el desarrollo de habilidades y destrezas prácticas, más que en la mera adquisición de contenidos teóricos.
...
*** link:Tema3/Enlaces.html[Enlaces de interés]
...
*** Aprendizaje autónomo o autodirigido donde los estudiantes asumen el control de su proceso de aprendizaje y trabajan de forma independiente para adquirir conocimientos y habilidades.
*** Tutoriales en modalidad de _flipped classroom_, donde los alumnos realizan la actividad de forma autónoma y se resuelven dudas en la clase presencial.
*** Estudio de casos prácticos de bases de datos orientadas a documentos en entornos reales o ficticios para fomentar la toma de decisiones, el debate y la argumentación.
*** Aprendizaje Basado en Competencias enfocado en el desarrollo de habilidades y destrezas prácticas, más que en la mera adquisición de contenidos teóricos. 
...
*** Aprendizaje autónomo o autodirigido donde los estudiantes asumen el control de su proceso de aprendizaje y trabajan de forma independiente para adquirir conocimientos y habilidades.
*** Tutoriales en modalidad de _flipped classroom_, donde los alumnos realizan la actividad de forma autónoma y se resuelven dudas en la clase presencial.
*** Estudio de casos prácticos de bases de datos orientadas a grafos en entornos reales o ficticios para fomentar la toma de decisiones, el debate y la argumentación.
*** Aprendizaje Basado en Competencias enfocado en el desarrollo de habilidades y destrezas prácticas, más que en la mera adquisición de contenidos teóricos. 
*** Actividades de laboratorio para realizar de forma autónoma en forma de proyecto.
...
*** Aprendizaje autónomo o autodirigido donde los estudiantes asumen el control de su proceso de aprendizaje y trabajan de forma independiente para adquirir conocimientos y habilidades.
*** Tutoriales en modalidad de _flipped classroom_, donde los alumnos realizan la actividad de forma autónoma y se resuelven dudas en la clase presencial. 
*** Estudio de casos prácticos de bases de datos orientadas a columnas en entornos reales o ficticios para fomentar la toma de decisiones, el debate y la argumentación.
*** Aprendizaje Basado en Competencias enfocado en el desarrollo de habilidades y destrezas prácticas, más que en la mera adquisición de contenidos teóricos. 
*** Actividades de laboratorio para realizar de forma autónoma en forma de proyecto.